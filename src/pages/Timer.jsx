...
export default function Timer(props) {
    ...
    return (
        <div className="d-flex justify-content-center align-items-center vh-100">
                ...
                <div className="row mt-5">
                    ...
                    >
                        ...
                        <div className="container text-center p-4 shadow rounded bg-light">
                            ...
                            <div className={`display-4 mb-4 ${time >= warningTime ? 'text-danger animate__animated animate__flash' : ''}`}                        >
                                {formatTime(time)}
                            </div>
                            ...
                            <div className="row mt-3">
                                ...
                                <div className="col-12 col-sm-4 mb-2 mb-sm-0">
                                    <button className="btn btn-primary w-100"
                                        onClick={generateReport} disabled={start}>
                                        Generate Report
                                    </button>
                                </div>
            ...
            <div className={`modal fade ${showCloseModal ? 'show d-block' : ''}`}
                tabIndex="-1" role="dialog"
                aria-hidden={!showCloseModal}>
                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-footer">
                            <button type="button"
                                ...
                                onClick={closeCloseModal}>Close</button>
                            <button type="button"
